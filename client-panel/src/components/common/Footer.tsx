...
const footerLinks = [
  {
    ...
    links: [
      ...
      { label: "Rate Calculator", href: "/resources/rate-calculator" },
      { label: "Weight Estimator", href: "/resources/weight-estimator" },
      { label: "Track Shipment", href: "/track" },
      { label: "Integrations", href: "/integrations/sales-channels" },
    ],
  },
  {
    title: "Company",
...
/* ─── social icons (inline SVGs for independence) ─── */
const socials = [
  {
    label: "Twitter",
    href: "#",
...
export function Footer() {
  return (
    <footer className="section-dark relative text-white">
      <div className="relative z-10 max-w-container-xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* ─── Main footer grid ─── */}
